...
//за да работи файла, предоставен за проекта, ми трябваше да сменя
//имената от кирилица на латиница, както и във функциите , които създават
//параметрични повърхнини, да добавя трети аргумент, който представлява резултата,
//тъй като се оказа, че в проекта си ползвам по-нова версия на three.js и това е някакво
//ново изискване. Променил съм и цветовете на човечето
